...
| doppler.metric-expiration<br />FIREHOSE_EXPORTER_DOPPLER_METRIC_EXPIRATION | No | 5 minutes | How long Cloud Foundry Container and HttpStartStop metrics are valid |
